...
#ifndef  _SO_SF_DMBUFFER_ENGINE_H
#define  _SO_SF_DMBUFFER_ENGINE_H
...
class SoDMBufferEngine : public SoEngine {

    SO_ENGINE_ABSTRACT_HEADER( SoDMBufferEngine );
